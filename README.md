...
The Angular build output is generated into the `docs/` directory, which is configured as the GitHub Pages source.

## Project Context

This project was created as a learning and practice project to strengthen:
- algorithmic thinking
- frontend development with Angular
- structured implementation of programming exercises

The original tasks are based on exercises from a Java programming course and were adapted for Angular and TypeScript.
